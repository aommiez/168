...
if($_SERVER["REQUEST_METHOD"]=="POST"){
    ...
    $query = "update promotion SET title=:title,description=:description,content=:content,updated_at=:updated_at,tags=:tags WHERE id=:id";
...
<form class="form-horizontal" method="post" enctype="multipart/form-data">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="tags" name="tags" type="text" placeholder="" class="form-control input-md" required="" value="<?php echo $param["tags"];?>">
            </div>
        </div>
